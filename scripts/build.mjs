...
async function createBundle(target) {
  ...
  const bundle = ['// Generated by scripts/build.mjs for file:// portable usage.', guides, classGuides, classBuildGuides, specGuides, dungeons, raids, professions, farming, reputation, assets, subscriptions, filters, app].join('\n\n');
