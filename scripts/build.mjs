...
async function createBundle(target) {
  ...
  const bundle = ['// Generated by scripts/build.mjs for file:// portable usage.', guides, classGuides, classBuildGuides, specGuides, dungeons, professions, farming, assets, subscriptions, filters, app].join('\n\n');
